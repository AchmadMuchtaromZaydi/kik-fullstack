                            ...
                            <?php else: ?>
                                <div class="text-danger">
                                    ...
                                    <small class="text-muted">Path:
                                        <?php echo e($organisasi->dokumen_ktp->image ?? 'Tidak ada'); ?></small>
                                </div>
                            <?php endif; ?>
                        <?php else: ?>
                        ...
                        <?php if($organisasi->dokumen_pas_foto): ?>
                            ...
                            <?php else: ?>
                                <div class="text-danger">
                                    ...
                                    <p>File tidak ditemukan di storage</p>
                                    <small class="text-muted">Path:
                                        <?php echo e($organisasi->dokumen_pas_foto->image ?? 'Tidak ada'); ?></small>
                                </div>
                            <?php endif; ?>
                        <?php else: ?>
                            <div class="text-muted">
                        ...
                        <?php if($organisasi->dokumen_banner): ?>
                            ...
                            <?php else: ?>
                                <div class="text-danger">
                                    ...
                                    <p>File tidak ditemukan di storage</p>
                                    <small class="text-muted">Path:
                                        <?php echo e($organisasi->dokumen_banner->image ?? 'Tidak ada'); ?></small>
                                </div>
                            <?php endif; ?>
                        <?php else: ?>
                            <div class="text-muted">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <small>
                        ...
                        <?php if($organisasi->dokumen_ktp): ?>
                            <strong>KTP Original Path:</strong> <?php echo e($organisasi->dokumen_ktp->image); ?><br>
                            <strong>KTP Resolved Path:</strong>
                            <?php echo e($organisasi->getFilePath($organisasi->dokumen_ktp)); ?><br>
                        <?php endif; ?>
                    </small>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Debug Info:', {
                organisasiId: <?php echo e($organisasi->id); ?>,
                dokumenKtp: <?php echo json_encode($organisasi->dokumen_ktp, 15, 512) ?>,
                dokumenPasFoto: <?php echo json_encode($organisasi->dokumen_pas_foto, 15, 512) ?>,
                dokumenBanner: <?php echo json_encode($organisasi->dokumen_banner, 15, 512) ?>,
                dokumenKegiatan: <?php echo json_encode($organisasi->dokumen_kegiatan, 15, 512) ?>
            });
        });
    </script>
