        ...
        <div class="verify-body">
            ...
            <?php if(session('email_error')): ?>
                <div class="alert alert-danger alert-dismissible fade show">
                    ...
                    <strong>Gagal Mengirim Email!</strong> <?php echo e(session('email_error')); ?>
            ...
            <form method="POST" action="<?php echo e(route('auth.verify.post')); ?>" id="verifyForm">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="code-inputs">
                        <?php for($i = 1; $i <= 6; $i++): ?>
                            <input type="text" class="code-input" name="code[]" maxlength="1"
                                data-index="<?php echo e($i); ?>" autocomplete="off">
                        <?php endfor; ?>
                    </div>
            ...
            <form id="resend-form" action="<?php echo e(route('auth.resend.code')); ?>" method="POST" style="display: none;">
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Project\kik-fullstack-main (2)\Project\kik-fullstack\resources\views/auth/verify.blade.php ENDPATH**/ ?>