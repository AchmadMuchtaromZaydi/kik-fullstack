            ...
            <div class="col-md-3">
                <div class="sticky-sidebar">
                    ...
                    <div class="back-navigation mb-4">
                        <a href="<?php echo e(route('admin.kesenian.index')); ?>"
                    ...
                    <div class="card border-0 shadow-sm mb-4 progress-card">
                        <div class="card-header bg-gradient-primary text-white">
                            ...
                            <div class="progress-overall mt-2">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    ...
                                    <small class="fw-bold"><?php echo e($completedSteps); ?>/<?php echo e($totalSteps); ?></small>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="progress-steps">
                                ...
                                <div
                                    class="progress-step <?php echo e(in_array($tabActive, ['general', 'data_organisasi', 'data_anggota', 'data_inventaris', 'data_pendukung', 'review']) ? 'active' : ''); ?>">
                                ...
                                <div
                                    class="progress-step <?php echo e(in_array($tabActive, ['data_organisasi', 'data_anggota', 'data_inventaris', 'data_pendukung', 'review']) ? 'active' : ''); ?>">
                                    <div class="step-indicator">
                                    ...
                                    <div class="step-status">
                                        <?php if($verifikasi = $verifikasiData->where('tipe', 'data_organisasi')->first()): ?>
                                            <?php if($verifikasi->status == 'valid'): ?>
                                ...
                                <div
                                    class="progress-step <?php echo e(in_array($tabActive, ['data_anggota', 'data_inventaris', 'data_pendukung', 'review']) ? 'active' : ''); ?>">
                                    <div class="step-indicator">
                                ...
                                <div
                                    class="progress-step <?php echo e(in_array($tabActive, ['data_inventaris', 'data_pendukung', 'review']) ? 'active' : ''); ?>">
                                    <div class="step-indicator">
                                ...
                                <div
                                    class="progress-step <?php echo e(in_array($tabActive, ['data_pendukung', 'review']) ? 'active' : ''); ?>">
                                    <div class="step-indicator">
                                ...
                                <div class="progress-step <?php echo e($tabActive == 'review' ? 'active' : ''); ?>">
                                    <div class="step-indicator">
                    ...
                    <div class="card border-0 shadow-sm info-card">
                        ...
                        <div class="card-body">
                            <div class="info-item">
                                ...
                                <div class="info-value"><?php echo e($organisasi->nama); ?></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">
                                ...
                                <div class="info-value"><?php echo e($organisasi->nama_ketua); ?></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">
                                ...
                                <div class="info-value"><?php echo e($organisasi->nama_kecamatan ?? '-'); ?></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">
                                ...
                                <div class="info-value">
                                    <span
                                        class="status-badge <?php echo e($organisasi->status == 'Request' ? 'warning' : ($organisasi->status == 'Allow' ? 'success' : 'danger')); ?>">
