            ...
            <div class="col-md-6">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($organisasi->tanggal_berdiri ? $organisasi->tanggal_berdiri->format('d/m/Y') : '-'); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($organisasi->sub_kesenian_nama && $organisasi->sub_kesenian_nama != 'Tidak ada sub jenis'): ?>
            ...
            <div class="col-md-6">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td><?php echo e($organisasi->jumlah_anggota); ?> orang</td>
                    </tr>
                    <tr>
                        <th>Alamat</th>
                    ...
                    <tr>
                        <th>Status</th>
                        <td><?php echo $organisasi->status_badge; ?></td>
                    </tr>
                </table>
            </div>
        </div>
