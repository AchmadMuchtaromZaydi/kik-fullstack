...
class KesenianController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Data untuk dropdown filter kecamatan
        $kecamatanList = Organisasi::whereNotNull('nama_kecamatan')->where('nama_kecamatan', '!=', '')->select('nama_kecamatan')->distinct()->orderBy('nama_kecamatan')->pluck('nama_kecamatan')->toArray();

        // Tambahkan kecamatan Banyuwangi jika belum ada
        $kecamatanBanyuwangi = ['Banyuwangi', 'Bangorejo', 'Cluring', 'Gambiran', 'Genteng', 'Giri', 'Glagah', 'Glenmore', 'Kabat', 'Kalibaru', 'Kalipuro', 'Licin', 'Muncar', 'Pesanggaran', 'Purwoharjo', 'Rogojampi', 'Sempu', 'Singojuruh', 'Srono', 'Tegaldlimo', 'Tegalsari', 'Wongsorejo'];
    ...
    public function create()
    {
        ...
        $kecamatanList = ['Banyuwangi', 'Bangorejo', 'Cluring', 'Gambiran', 'Genteng', 'Giri', 'Glagah', 'Glenmore', 'Kabat', 'Kalibaru', 'Kalipuro', 'Licin', 'Muncar', 'Pesanggaran', 'Purwoharjo', 'Rogojampi', 'Sempu', 'Singojuruh', 'Srono', 'Tegaldlimo', 'Tegalsari', 'Wongsorejo'];
        sort($kecamatanList);
